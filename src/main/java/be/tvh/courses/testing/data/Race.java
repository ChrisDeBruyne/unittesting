 ...
 */
package be.tvh.courses.testing.data;


import static be.tvh.courses.testing.data.Alignment.EVIL;
import static be.tvh.courses.testing.data.Alignment.GOOD;
import static be.tvh.courses.testing.data.Alignment.NEUTRAL;
