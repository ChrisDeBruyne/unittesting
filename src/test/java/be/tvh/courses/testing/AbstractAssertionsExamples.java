...
import be.tvh.courses.testing.comparator.*;
import be.tvh.courses.testing.condition.PotentialMvpCondition;
import be.tvh.courses.testing.data.BasketBallPlayer;
import be.tvh.courses.testing.data.Name;
...
import static be.tvh.courses.testing.data.Race.*;
