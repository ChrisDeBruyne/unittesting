...
import be.tvh.courses.testing.comparator.AtPrecisionComparator;
import be.tvh.courses.testing.data.Person;
import be.tvh.courses.testing.data.Ring;
import be.tvh.courses.testing.data.TolkienCharacter;
import be.tvh.courses.testing.data.movie.Movie;
...
import static be.tvh.courses.testing.data.Race.ELF;
import static be.tvh.courses.testing.data.Race.HOBBIT;
import static be.tvh.courses.testing.data.Ring.*;
...
public class AssertJBasicAssertionsExamples extends AbstractAssertionsExamples {
